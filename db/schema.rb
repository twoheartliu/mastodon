...
ActiveRecord::Schema[8.1].define(version: 2026_06_28_132313) do
  ...
  create_table "on_this_day_records", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.datetime "created_at", null: false
    t.jsonb "data", default: {}, null: false
    t.date "date", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "date"], name: "index_on_this_day_records_on_account_id_and_date", unique: true
    t.index ["date"], name: "index_on_this_day_records_on_date"
  end
  ...
  add_foreign_key "on_this_day_records", "accounts", on_delete: :cascade
