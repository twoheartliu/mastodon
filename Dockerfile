...
RUN apt -y --no-install-recommends install \
	  libssl1.1 libpq5 imagemagick ffmpeg git vim nano lrzsz \
...
RUN plugin install https://github.com/medcl/elasticsearch-analysis-ik/releases/download/v6.8.10/elasticsearch-analysis-ik-6.8.10.zip && \
    plugin install https://github.com/medcl/elasticsearch-analysis-stconvert/releases/download/v6.8.10/elasticsearch-analysis-stconvert-6.8.10.zip
