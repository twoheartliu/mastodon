...
import initialState, { me, owner, singleUserMode, trendsEnabled, trendsAsLanding, disableHoverCards, layoutType } from '../../initial_state';
...
class SwitchingColumnsArea extends PureComponent {
  ...
  componentDidUpdate (prevProps) {
    if (![this.props.location.pathname, '/'].includes(prevProps.location.pathname)) {
      // Only call handleChildrenContentChange if columnsAreaRef exists and has the method
      if (this.columnsAreaRef && typeof this.columnsAreaRef.handleChildrenContentChange === 'function') {
        this.columnsAreaRef.handleChildrenContentChange();
      }
    }
  ...
  render () {
    ...
    return (
      <ColumnsContextProvider multiColumn={!singleColumn}>
        <ColumnsAreaContainer ref={this.setRef} singleColumn={singleColumn} layoutType={layoutType}>
          <WrappedSwitch>
            {redirect}
...
class UI extends PureComponent {
  ...
  render () {
    ...
    const isSingleColumn = layout === 'mobile' || layoutType !== 'advanced';
